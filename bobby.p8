        ...
        ['camera']={
            ...
            main_update=function(s)
                ...
                if(bobby.pos.x>levels[cur_level+1].borders[2]) then
                    cur_level +=1
                    tarpos = v(levels[cur_level+1].borders[1]+1,0)
                    s:move(tarpos)
                end
                if(bobby.pos.x<levels[cur_level+1].borders[1]) then
                    cur_level -=1
                    tarpos = v(levels[cur_level+1].borders[1],0)
                    s:move(tarpos)
                end
            end,
...

