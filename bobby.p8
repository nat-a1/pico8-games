...
---------------------------------------
    ...
    local entity_classes = {
        ...
        ['camera']={
            update=nul,cur_screen = 0,
            pos = v(0,0),
            main_update=function(s)
                local player_screen = bobby.pos.x\128 + (bobby.pos.y\128 *4)
                if(player_screen != s.cur_screen) then 
                    s.cur_screen  = player_screen
                    s:move(v((bobby.pos.x\128) * 128,(bobby.pos.y\128) * 128))
                end
            end,
            move = function(s,tarpos)
                s.update=cowrap(function(s)
                    local tarpos = tarpos
                    ...
                    s.pos= tarpos
                    s.update = s.main_update
                end)
            end,
            draw=function(s)
                camera(s.pos.x,s.pos.y)
            end,
            init=function(s)
                s.update=s.main_update
            end
...
__gfx__

...

...
__gff__

...

